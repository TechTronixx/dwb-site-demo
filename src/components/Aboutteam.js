...
const AboutTeam = () => {
  ...
  return (
    <div id="about-team" className="bg-gray-900 py-16">
      <Container
        data-aos="fade-up"
      ...
      >
        ...
        <Row className="gap-6">
          <Col md={6} className="mb-4">
            <div className="bg-opacity-20 bg-white rounded-lg shadow-md p-6">
              <div>
        ...
        <Row className="mt-8">
          {teamMembers.map((member, index) => (
            <Col md={6} lg={3} key={index} className="mb-4">
              <div className="bg-opacity-20 bg-white rounded-lg shadow-md p-6 text-center">
